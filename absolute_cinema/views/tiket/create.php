...
$listJadwal = $jadwalVM->fetchAll();

if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $tiketVM->addTiket($_POST);
...
<head>
    ...
    <title>Beli Tiket - Cinema Tix</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-custom">
                    <div class="card-header py-3"><i class="fas fa-cart-plus me-2"></i> Form Pembelian Tiket</div>
                    <div class="card-body p-4">
                        <form method="POST" action="">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <select id="jadwal_select" name="id_jadwal" class="form-select" required>
                                        <option value="" selected disabled>-- Pilih Jadwal Tayang --</option>
                            ...
                            <div class="d-flex justify-content-end gap-2 mt-3">
                                ...
                                <button type="submit" class="btn btn-save px-4">Bayar & Cetak</button>
                            </div>
                        </form>
                    </div>
                </div>
