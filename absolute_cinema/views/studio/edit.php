...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if ($viewModel->updateStudio($_POST['id'], $_POST['nama_studio'], $_POST['kapasitas'])) {
        header("Location: index.php");
        exit;
    }
}
...
<head>
    ...
    <title>Edit Studio - Cinema Tix</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <div class="card card-custom">
                    <div class="card-header py-3"><i class="fas fa-edit me-2"></i> Edit Data Studio</div>
                        ...
                        <form method="POST" action="">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="nama_studio" class="form-control"
                                    value="<?= $data->nama_studio ?>" required>
                            </div>
                            <div class="mb-4">
